...
const titulos = ["Nombre", "Apellido", "Desarrollo", "Inglés", "Habilidades", "Review", "Promedio", "Editar", "Eliminar"];
...
btn.addEventListener("click", () => {
    ...
    if (nombre != "" && apellido != "" && desarrollo != "" && ingles != "" && habilidades != "" && review != "") {
        ...
        inputs.forEach((input) => {
            ...
            const info = [nombre, apellido, desarrollo, ingles, habilidades, review, promedio, btnEditar, btnEliminar];
            ...
            info.forEach((infoText) => {
                ...
                if (infoText == btnEditar || infoText == btnEliminar) {
                    ...
                    asignarColor(infoText, td, desarrollo, ingles, habilidades, review, promedio);
                    infoRow.appendChild(td);
                }
...
function asignarColor(infoText, td, desarrollo, ingles, habilidades, review, promedio) {
    if (infoText == desarrollo || infoText == ingles || infoText == habilidades || infoText == review || infoText == promedio) {
        if (parseFloat(infoText) >= 3) {
            td.style.backgroundColor = "#6e955e"
        } else {
            td.style.backgroundColor = "#ff2e2e"
        }
    }
}
