...
const titulos = ["Nombre", "Apellido", "Nota desarrollo", "Editar", "Eliminar"];
...
btn.addEventListener("click", () => {
    ...
    if (nombre != "" && apellido != "" && materia != "Elegir materia" && materia != "") {
        if (materia <= 5 && materia >= 0) {
            const info = [nombre, apellido, materia, btnEditar, btnEliminar];
...
function clearInputs() {
    const inputs = [names, lastName, subject];
